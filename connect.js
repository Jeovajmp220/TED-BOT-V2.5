...
console.log(colors.green(`〔 - _ tednexMart 2.0 _ - CONECTADA COM SUCESSO... 〕`))
await tednexmart.sendPresenceUpdate("available")
await tednexmart.updateProfileStatus(`Conectado! [ ${hora} - ${date} ] - Grupo: https://chat.whatsapp.com/K6eFRchmYYCAFNekRApm3y`)
break;
